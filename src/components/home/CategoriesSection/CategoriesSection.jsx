...
// حذف شد Record<string, React.ElementType> تایپ 
const iconMap = {
  "book-open": BookOpen,
  "mic": Mic,
...
export function CategoriesSection() {
  return (
    <section className="py-16 lg:py-24 bg-muted/30">
      <div className="container px-4"> {/* اضافه شد برای جلوگیری از چسبیدن به دیواره‌ها در موبایل container به  px-4 */}
        {/* عنوان */}
        <div className="text-center mb-12">
          <h2 className="text-2xl lg:text-3xl font-bold text-foreground mb-4"> {/* اصلاح شد text-headline احتمالا با کلاس‌های استاندارد */}
          ...
          {mahfilCategories.map((category, index) => {
            ...
            return (
              <Link
                ...
                className="group relative p-6 rounded-2xl bg-card border border-border/50 hover:border-primary/30 hover:shadow-lg transition-all duration-300 animate-fade-in"
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mb-3 line-clamp-2"> {/* اضافه شد برای ثبات ارتفاع کارت‌ها line-clamp-2 */}
